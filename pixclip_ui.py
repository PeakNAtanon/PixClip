        ...
        translations = {
            "th": {
                ...
                "sections": (
                    ...
                    ("09  ถ้างานมีปัญหา", "ตรวจ Install tools และพื้นที่ว่างก่อน ลอง Best available หากจำกัดความละเอียดแล้วไม่มีรูปแบบที่รองรับ เปิด Job log เพื่อดูสาเหตุ และกด Retry หลังแก้ปัญหาแล้ว"),
                    ("10  หมายเหตุ", "การตั้งเวลาและคิวทำงานขณะที่ PixClip เปิดอยู่เท่านั้น มาสคอตจะแสดง READY, WORKING, OK หรือ CHECK ตามสถานะงาน ไฟล์ประวัติถูกเก็บในโฟลเดอร์ข้อมูลผู้ใช้ของ Windows/Linux"),
                ),
            },
            "en": {
                ...
                "sections": (
                    ...
                    ("09  Troubleshooting", "Check Install tools and free disk space first. Try Best available if a resolution limit has no compatible format. Open Job log for details and press Retry after fixing the issue."),
                    ("10  Notes", "Queue and scheduled recordings run only while PixClip is open. The mascot shows READY, WORKING, OK, or CHECK. Job history is stored in the Windows/Linux user data folder."),
                ),
            },
        }
